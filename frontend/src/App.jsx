    ...
    <div className="min-h-screen bg-[#f8fafc] flex animate-in fade-in duration-700 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-20 bg-white/80 backdrop-blur-md border-b border-slate-100 px-8 flex justify-between items-center sticky top-0 z-30">
          ...
          <div className="flex items-center gap-4"><div className="text-right hidden sm:block"><p className="text-sm font-black text-slate-800 uppercase italic">보안 관리자 (대표님)</p><div className="flex justify-end items-center gap-1.5 mt-0.5"><span className="w-1.5 h-1.5 bg-emerald-500 rounded-full animate-pulse"></span><p className="text-[9px] text-emerald-500 font-bold uppercase tracking-widest">시스템 인증됨</p></div></div><div className="w-10 h-10 rounded-2xl bg-slate-50 flex items-center justify-center border border-slate-200 text-slate-500 shadow-inner"><Users size={18} /></div></div>
        </header>
...
export default function App() {
  ...
  return (
    <div className="selection:bg-blue-600 selection:text-white h-screen overflow-hidden">
      ...
      <style>{`body { font-family: 'Noto Sans KR', sans-serif; overflow: hidden; } .no-scrollbar::-webkit-scrollbar { display: none; }`}</style>
    </div>
  );
}
